module.exports = {
    ...
    [
      {
        ...
        image:
          "https://i5.walmartimages.com/asr/cf61f8a5-1129-4590-a5d9-fd7cd5bafe59.fa1f31538ed4cf2647ee9435813abdff.jpeg?odnWidth=undefined&odnHeight=undefined&odnBg=ffffff",
        price: 276.75,
        category: "",
      ...
      {
        name:
          "RCA - 10 Cu Ft Top-Freezer Apartment-size RETRO Refrigerator - Blue, RFR1055",
        description:
          "This RCA 10 cu. ft. top freezer refrigerator has the storage options you're looking for, if you simply want a little extra fridge space in your home or office. Door bins conveniently keep beverage cans and bottles stored on the door, and glass shelves and a crisper in the fresh food section makes this refrigerator easy to organize.RCA - 10 Cu Ft Top-Freezer Apartment-size Refrigerator - Retro",
        image:
          "https://i5.walmartimages.com/asr/5deba39c-deda-4cf6-9cfa-59fffeba5b05_3.c9a9629c84899be425cc0f1a560d270d.jpeg?odnWidth=undefined&odnHeight=undefined&odnBg=ffffff",
        price: 349.02,
        category: "",
        stock: Math.floor(Math.random() * 20 + 1),
        featured: Math.random() <= 0.5,
      ...
      {
        name:
          "Frigidaire FFTR1814TB 30 Inch Freestanding Top Freezer Refrigerator Black",
        description:
        ...
        image:
          "https://i5.walmartimages.com/asr/fbc01970-3408-4d32-b0c9-60ea5c77cd3f_1.423d4e1fa09afdace348c66f477eaefd.jpeg?odnWidth=undefined&odnHeight=undefined&odnBg=ffffff",
        price: 799.0,
        category: "",
        stock: Math.floor(Math.random() * 20 + 1),
        featured: Math.random() <= 0.5,
      ...
      {
        name:
          "Frigidaire FFSS2315TD 33 Inch Freestanding Side by Side Refrigerator Black Stainless Steel",
        description:
        ...
        image:
          "https://i5.walmartimages.com/asr/87a95749-97e0-49f1-aac9-26893c28d3e0_1.ee7b8cc79686f6309a0fe8561fde65c7.jpeg?odnWidth=1000&odnHeight=1000&odnBg=ffffff",
        price: 1.495,
        category: "",
        stock: Math.floor(Math.random() * 20 + 1),
        featured: Math.random() <= 0.5,
      ...
      {
        name:
          "Frigidaire Ffss2615t 36 Wide 25.5 Cu. Ft. Side By Side Refrigerator",
        description:
      ...
      {
        name:
          "RCA 5.5 Cu Ft Side by Side 2 Door Fridge Freezer RFR551, Stainless",
        description:
        ...
        image:
          "https://i5.walmartimages.com/asr/96dcd0fc-b65e-47af-b6b3-c1d3684dc9f2_1.46e349c214c142db5d6554e6ae37fe76.jpeg?odnWidth=1000&odnHeight=1000&odnBg=ffffff",
        price: 354.57,
        category: "",
        stock: Math.floor(Math.random() * 20 + 1),
        featured: Math.random() <= 0.5,
      ...
      {
        name:
          "Frigidaire FFHI1832TS - Refrigerator/freezer - top-freezer - freestanding - width: 30 in - depth: 32.6 in - height: 66.5 in - 18 cu. ft - stainless steel",
        description:
        ...
        image:
          "https://i5.walmartimages.com/asr/f01d4f74-9576-4839-a959-d0385a6970ee.71d495f38cbe1be408a7eef60f06be37.jpeg?odnWidth=undefined&odnHeight=undefined&odnBg=ffffff",
        price: 1.306,
        category: "",
        stock: Math.floor(Math.random() * 20 + 1),
        featured: Math.random() <= 0.5,
      ...
      {
        name:
          "Frigidaire Fgsc2335t 36 Wide 22.2 Cu. Ft. Side By Side Refrigerator",
        description:
        ...
        image:
          "https://i5.walmartimages.com/asr/fc926035-d155-4b78-8aed-d435ffa38685.688ffad390dc954cd76cf2ec6ae5048f.jpeg?odnWidth=undefined&odnHeight=undefined&odnBg=ffffff",
        price: 2.548,
        category: "",
        stock: Math.floor(Math.random() * 20 + 1),
        featured: Math.random() <= 0.5,
      ...
      },
      {
        ...
        image:
          "https://i5.walmartimages.com/asr/2d35fa22-058b-42e9-89a4-5fa5b123c491_8.6fa252477288717f7fe9d2a07dca84c1.jpeg?odnWidth=undefined&odnHeight=undefined&odnBg=ffffff",
        price: 2.548,
        category: "",
        stock: Math.floor(Math.random() * 20 + 1),
        featured: Math.random() <= 0.5,
    ...
    [
      {
        ...
        image:
          "https://i5.walmartimages.com/asr/656fd951-eb35-40a5-8be7-e05bb669099c.22e33c6c2e8ae0f4a681bdbc46e2bfdb.jpeg?odnWidth=undefined&odnHeight=undefined&odnBg=ffffff",
        price: 897.99,
        category: "",
        stock: Math.floor(Math.random() * 20 + 1),
        featured: Math.random() <= 0.5,
      ...
      {
        name:
          "SAMSUNG 65 Class 4K UHD (2160P) the Frame QLED Smart TV QN65LS03T 2020",
        description:
        ...
        image:
          "https://i5.walmartimages.com/asr/45aa5c00-17b1-4502-86d8-77a66b77b20f.0cf2075cc504fa1be7d83778e5c1d5bb.jpeg?odnWidth=undefined&odnHeight=undefined&odnBg=ffffff",
        price: 1.897,
        category: "",
        stock: Math.floor(Math.random() * 20 + 1),
        featured: Math.random() <= 0.5,
      ...
      },
      {
        ...
        image:
          "https://i5.walmartimages.com/asr/aa0d128b-e473-458f-b4f2-8fd2377d1219.b3d975e286f1f87c140f777659775c1a.jpeg?odnWidth=undefined&odnHeight=undefined&odnBg=ffffff",
        price: 89.99,
        category: "",
        stock: Math.floor(Math.random() * 20 + 1),
        featured: Math.random() <= 0.5,
      ...
      },
      {
        ...
        image:
          "https://i5.walmartimages.com/asr/2d381361-730f-4f3f-a712-1d6be74e3b29.223e130cc31da8162f3fe8bac716753b.jpeg?odnWidth=undefined&odnHeight=undefined&odnBg=ffffff",
        price: 238.0,
        category: "",
        stock: Math.floor(Math.random() * 20 + 1),
        featured: Math.random() <= 0.5,
      ...
      {
        name:
          "Samsung 40 Class FHD (1080P) LED Smart TV UN40N5200 (2019 Model)",
        description:
        ...
        image:
          "https://i5.walmartimages.com/asr/c47959a8-b59e-41b8-b962-f0175123ad7e_1.b75ef5d998f996e32d919d2057cb3da7.jpeg?odnWidth=undefined&odnHeight=undefined&odnBg=ffffff",
        price: 247.99,
        category: "",
        stock: Math.floor(Math.random() * 20 + 1),
        featured: Math.random() <= 0.5,
      ...
      {
        name:
          "RCA Home and Travel 24 720P HD TV - With AC/DC Car Charger RT2471-AC, Black",
        description:
        ...
        image:
          "https://i5.walmartimages.com/asr/53cf5f85-914a-4495-8dd3-d6cb41f6bc61.a68a2073b740521e007b50466c23685c.jpeg?odnWidth=undefined&odnHeight=undefined&odnBg=ffffff",
        price: 98.0,
        category: "",
        stock: Math.floor(Math.random() * 20 + 1),
        featured: Math.random() <= 0.5,
      ...
      },
      {
        ...
        image:
          "https://i5.walmartimages.com/asr/1d5cac3d-d37f-4122-af67-d45d97d7f9e4_1.321f8a38ea181b39be37a03330624470.jpeg?odnWidth=undefined&odnHeight=undefined&odnBg=ffffff",
        price: 98.0,
        category: "",
        stock: Math.floor(Math.random() * 20 + 1),
        featured: Math.random() <= 0.5,
      ...
      },
      {
        ...
        image:
          "https://i5.walmartimages.com/asr/e961003c-d83d-4eb9-97a3-d61c2fa2664f_1.4fc2fca55de3caed7a5ce603ed59a7db.jpeg?odnWidth=undefined&odnHeight=undefined&odnBg=ffffff",
        price: 98.0,
        category: "",
        stock: Math.floor(Math.random() * 20 + 1),
        featured: Math.random() <= 0.5,
      ...
      },
      {
        ...
        image:
          "https://i5.walmartimages.com/asr/50e52eb7-c42a-4780-bf5b-c7e2f4d919a5_2.0709646a6e0a16fcbe047083ecfd3c9c.jpeg?odnWidth=1000&odnHeight=1000&odnBg=ffffff",
        price: 98.0,
        category: "",
        stock: Math.floor(Math.random() * 20 + 1),
        featured: Math.random() <= 0.5,
      ...
      },
      {
        ...
        image:
          "https://i5.walmartimages.com/asr/fc9f61cb-8c59-48b8-badb-7dfef5ccef2c_1.4fc2fca55de3caed7a5ce603ed59a7db.jpeg?odnWidth=undefined&odnHeight=undefined&odnBg=ffffff",
        price: 98.0,
        category: "",
        stock: Math.floor(Math.random() * 20 + 1),
        featured: Math.random() <= 0.5,
    ...
    [
      {
        ...
        image:
          "https://i5.walmartimages.com/asr/f268016e-db3b-4403-9b17-22ab52de12c7_1.8701c771a0ddf08350cd7bb985bbd8bb.jpeg?odnWidth=undefined&odnHeight=undefined&odnBg=ffffff",
        price: 39.92,
        category: "",
        stock: Math.floor(Math.random() * 20 + 1),
        featured: Math.random() <= 0.5,
      ...
      },
      {
        ...
        image:
          "https://i5.walmartimages.com/asr/7b6093f2-e3df-4846-b8bb-af05b8313e2d_1.8df76dfb3c84639e76b513c4368640d5.jpeg?odnWidth=undefined&odnHeight=undefined&odnBg=ffffff",
        price: 34.99,
        category: "",
        stock: Math.floor(Math.random() * 20 + 1),
        featured: Math.random() <= 0.5,
      ...
      {
        name:
          "Frigidaire 26 lb. Countertop Ice Maker EFIC117-SS, Stainless Steel",
        description:
        ...
        image:
          "https://i5.walmartimages.com/asr/7005c829-6193-4583-95d6-550e02f4abaa.2f24db55635ecb1f878294adbe0feddf.jpeg?odnWidth=undefined&odnHeight=undefined&odnBg=ffffff",
        price: 99.0,
        category: "",
        stock: Math.floor(Math.random() * 20 + 1),
        featured: Math.random() <= 0.5,
      ...
      {
        name:
          "BLACK+DECKER 3-Cup Electric Rice Cooker with Keep-Warm Function, White, RC503",
        description:
        ...
        image:
          "https://i5.walmartimages.com/asr/bc757893-9b50-49e6-ba6b-702c1fcfce81_1.e057af69068ba87ec5c55bbcea12b7fa.jpeg?odnWidth=undefined&odnHeight=undefined&odnBg=ffffff",
        price: 99.0,
        category: "",
        stock: Math.floor(Math.random() * 20 + 1),
        featured: Math.random() <= 0.5,
      ...
      },
      {
        ...
        image:
          "https://i5.walmartimages.com/asr/bed73402-4c89-4eec-ae82-cf1a427817e8_1.32394aa70fd1489717d6c486396ce558.jpeg?odnWidth=undefined&odnHeight=undefined&odnBg=ffffff",
        price: 99.99,
        category: "",
        stock: Math.floor(Math.random() * 20 + 1),
        featured: Math.random() <= 0.5,
      ...
      },
      {
        ...
        image:
          "https://i5.walmartimages.com/asr/ce4887ca-10cd-4bec-8e4b-b4bf7964a507_1.7ef4ec28c8567b555f3358c75099bb12.jpeg?odnWidth=undefined&odnHeight=undefined&odnBg=ffffff",
        price: 34.62,
        category: "",
        stock: Math.floor(Math.random() * 20 + 1),
        featured: Math.random() <= 0.5,
      ...
      {
        name:
          "Hamilton Beach 6-Speed Hand Mixer with Snap-On Case, Black, Model 62683",
        description:
        ...
        image:
          "https://i5.walmartimages.com/asr/0a1cbf08-7976-4541-b293-1f321ba0e5c1_1.4ad0f607ec497d35b80735b691640722.jpeg?odnWidth=undefined&odnHeight=undefined&odnBg=ffffff",
        price: 12.96,
        category: "",
        stock: Math.floor(Math.random() * 20 + 1),
        featured: Math.random() <= 0.5,
      ...
      },
      {
        ...
        image:
          "https://i5.walmartimages.com/asr/18652377-1a34-4154-925a-a51569ddee61_2.5da704269c4cbb2f250339ff59da724d.jpeg?odnWidth=undefined&odnHeight=undefined&odnBg=ffffff",
        price: 64.84,
        category: "",
        stock: Math.floor(Math.random() * 20 + 1),
        featured: Math.random() <= 0.5,
      ...
      },
      {
        ...
        image:
          "https://i5.walmartimages.com/asr/a67a1e6f-817e-4b27-9331-570e1805ac68_1.e83a8d64215f76d7c45821ca96dc16f8.jpeg?odnWidth=undefined&odnHeight=undefined&odnBg=ffffff",
        price: 69.88,
        category: "",
        stock: Math.floor(Math.random() * 20 + 1),
        featured: Math.random() <= 0.5,
      ...
      {
        name:
          "Hamilton Beach 2 Slice Extra-Wide Slot Toaster Chrome | Model# 22794",
        description:
        ...
        image:
          "https://i5.walmartimages.com/asr/42dfdbaf-8d1b-4e7e-bb37-fe912c84189a_2.b532a8b9ea9d172167fd190cdb76caa7.jpeg?odnWidth=undefined&odnHeight=undefined&odnBg=ffffff",
        price: 19.96,
        category: "",
        stock: Math.floor(Math.random() * 20 + 1),
        featured: Math.random() <= 0.5,
  ...
  brandNames: [
    ...
    },
    {
      name: "samsung",
      logo:
        "https://logos-marcas.com/wp-content/uploads/2020/04/Samsung-Logo.png",
    },
    {
      name: "jvc",
      logo: "https://cdn.worldvectorlogo.com/logos/jvc.svg",
    },
    {
      name: "black & decker",
      logo: "https://cdn.worldvectorlogo.com/logos/black-decker-3.svg",
    },
    {
      name: "hamilton beach",
